...
+ DS_INODE_BYTES + DS_FTL_BYTES + DS_NHASH_BYTES + EVENTQ_BYTES + RDAFWRQ_BYTES + HMAC_SIZE + DS_FILETB_BYTES + DS_FILELOC_BYTES) //DiskShield
...
#define TEMP_BUF_ADDR		(HIL_BUF_ADDR + HIL_BUF_BYTES)					// genera l purpose buffer
...
//#define DS_MAX_FILE (1024*1)
#define DS_MAX_FILE (1024*4)
...
#define DS_FILETB_ADDR (HMAC_BUFF + HMAC_SIZE)
#define DS_FILETB_BYTES (((DS_MAX_FILE+1) * sizeof(UINT32) + BYTES_PER_SECTOR - 1) / BYTES_PER_SECTOR * BYTES_PER_SECTOR)   

#define DS_FILELOC_ADDR (DS_FILETB_ADDR + DS_FILETB_BYTES)
#define DS_FILELOC_BYTES (((DS_MAX_FILE+1) * sizeof(UINT8) + BYTES_PER_SECTOR - 1) / BYTES_PER_SECTOR * BYTES_PER_SECTOR)   
