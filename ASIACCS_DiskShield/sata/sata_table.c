...
// DiskSheild : Add some commands 
/*
DS_Crate : Crate New File (key 저장)
DS_Open : send(file name, MAC)
DS_Close : send(fild id, MAC)
DS_Read :  send(file id, file offset, tag)
DS_Write : send(file id, file offset, tag, MAC, data)
DS_remove :   
*/
/*
//	Command Class, LBA type in Register FIS
